#ifndef RADAR_TARGET_CARTESIAN_ARRAY_DISPLAY_H
#define RADAR_TARGET_CARTESIAN_ARRAY_DISPLAY_H
...
{  
  ...
  class RadarTargetCartesianArrayDisplay: public rviz::MessageFilterDisplay<ainstein_radar_msgs::RadarTargetCartesianArray>
  {
    Q_OBJECT
  public:
    // Default constructor for the pluginlib::ClassLoader.
    RadarTargetCartesianArrayDisplay();
    virtual ~RadarTargetCartesianArrayDisplay();
  ...
  private:
      void processMessage( const ainstein_radar_msgs::RadarTargetCartesianArray::ConstPtr& msg );
      
      // Storage for the list of visuals.  It is a circular buffer where
      // data gets popped from the front (oldest) and pushed to the back (newest)
      boost::circular_buffer<boost::shared_ptr<RadarTargetCartesianArrayVisual>> visuals_;
...
#endif // RADAR_TARGET_CARTESIAN_ARRAY_DISPLAY_H
