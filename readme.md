# radar_ros_interface:
ROS nodes for interfacing with Ainstein radars based on custom message types defined in the [radar_sensor_msgs](https://github.com/AinsteinAI/radar_sensor_msgs) package.

## Functionality

All development and testing has been done in **Ubuntu 16.04 with ROS Kinetic.***
