...
public:
  ...
  {
  public:
	FilterState(double target_range, double target_speed, double target_azimuth, double target_elevation,
	...
	{
	  return Eigen::Vector4d(this->range, this->speed, this->azimuth, this->elevation);
	}
