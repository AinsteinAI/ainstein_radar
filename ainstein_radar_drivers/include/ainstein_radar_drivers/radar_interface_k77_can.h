#ifndef RADAR_INTERFACE_K77_CAN_H_
#define RADAR_INTERFACE_K77_CAN_H_
...
{
  class RadarInterfaceK77CAN: public RadarInterface<can_msgs::Frame>
  {
  public:
    RadarInterfaceK77CAN( ros::NodeHandle node_Handle,
			  ros::NodeHandle node_Handle_private );
    ~RadarInterfaceK77CAN()
    {
    }
...
#endif // RADAR_INTERFACE_K77_CAN_H_
