#ifndef RADAR_INTERFACE_SDOD_CAN_H_
#define RADAR_INTERFACE_SDOD_CAN_H_
...
{
  class RadarInterfaceSDODCAN: public RadarInterface<can_msgs::Frame>
  {
  public:
    RadarInterfaceSDODCAN( ros::NodeHandle node_Handle,
			  ros::NodeHandle node_Handle_private );
    ~RadarInterfaceSDODCAN()
    {
    }
...
#endif // RADAR_INTERFACE_SDOD_CAN_H_
